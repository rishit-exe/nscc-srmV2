    ...
    <div id="about-us">
      <>
        <div className="bg-gradient-to-b from-[#0a192f] via-[#112240] to-[#061529] min-h-screen relative">
          ...
          <div className="text-white p-5 md:flex md:flex-col md:items-center lg:block space-y-5 blend-mode-plus-light relative z-10">
            {/* Simplified main content text */}
            <div className="text-2xl text-center md:text-left lg:w-[950px] font-helvetica-neue relative">
              <p className="hover:text-shadow-lg transition-all duration-300">
